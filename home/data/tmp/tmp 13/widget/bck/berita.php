...
<div class="col-md-7 sidebar">
				...
				<fieldset> 
					<table>
						...
						<input name="p" value="berita" id="page" type="hidden">
							<input value="<?php echo $judul;?>" type="hidden" name="Berdasarkan" id="Berdasarkan" name="Berdasarkan" id="Berdasarkan">
			...
			<?php
				...
				<div class="">
					...
					<a href='admin/upload/<?php echo $data["$foto"]; ?>'><img onerror="this.src='<?php echo $imageerror; ?>'" width='200' height='150' src='admin/upload/<?php echo $data["$foto"]; ?>'></a>
			    	<?php echo (substr($data["$isi"],0,300)); ?>...
					<br>
					<a class="btn btn-success btn-xs"  href="index.php?p=berita&action=detail&proses=<?php echo (substr($data["$id"],0,100)); ?>">BACA SELENGKAPNYA... </a>
			    </div>
