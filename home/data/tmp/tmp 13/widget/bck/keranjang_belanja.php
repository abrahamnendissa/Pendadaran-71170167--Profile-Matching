...
function keranjang_belanja($field,$tabel,$id,$tabel_produk,$id_produk,$nama_produk,$foto,$harga,$jumlah,$id_pelanggan,$judul,$pakai_ongkir,$tombolfinish)
	...
	<table <?php tabel(100,'%',1,'left');  ?> >
		...
		<tbody>
			...
			$no = $startRow;
			$querytabel="SELECT * FROM $tabel where status='proses'";
        ...
        <tr class="event2">	
			...
			<td align="left">
				...
				<input type="number" style="width: 3em" min="1" value="<?php $jumlah_keseluruhan = $jumlah_keseluruhan +  ($data["$jumlah"]); echo  ($data["$jumlah"]); ?>" name="jumlah">
				<?php 
			...
			<td class="th_border cell" align="left" width="200">
						<table border="0">
							<tr>
								<td>
									<a href="<?php index(); ?>?p=keranjang_belanja&action=delete&proses=<?php echo $data["$id"]; ?>">
...
<form  method="get">
<input name="p" value="keranjang_belanja" type="hidden">
...
<table class="table">
	...
	<td>:</td>
	<td>
		<textarea required  name="alamat_pengiriman">
		</textarea>
	</td>
	</tr>
	...
	<td>:</td>
	<td>
		<input required name="no_telepon_penerima" type="number">
	</td>
	</tr>
	...
	<td>:</td>
	<td>
		<input required name="nama_penerima" id="nama_penerima" >
	</td>
	</tr>
</table>
</div>
