...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <hr class="message-inner-separator">
            <p>Silahkan input Data Profil  dibawah ini.</p>
        </div>
    </div>
                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_profil", "id_profil", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_profil", "id_profil", "10"); ?>" name="id_profil" placeholder="Id Profil " id="id_profil" required="required">
