...
<body>
    ...
    <a target="blank" href="cetak.php?berdasarkan=data_member&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_export('Export Excel'); ?>
    </a>

    <a target="blank" href="cetak.php?berdasarkan=data_member&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_cetak('Cetak'); ?>
    </a>
    ...
    <div style="overflow-x:auto;">
        <table <?php tabel(100, '%', 1, 'left'); ?> >
            <tr>								  
                ...
                <th align="center" class="th_border cell"  >Tingak Kebugaran </th>
                <th align="center" class="th_border cell"  >Preferensi Pelatihan </th>
            ...
            <tbody>
                ...
                while ($data = mysql_fetch_array($proses)) {
                    ...
                    <tr class="event2">	
                        ...
                        <td align="center"><?php echo $data['tingak_kebugaran']; ?></td>
                        <td align="center"><?php echo $data['preferensi_pelatihan']; ?></td>
